...
INSERT INTO cycles (id, phase, label, window_open, window_close, is_active) VALUES
  ('c0000000-0000-0000-0000-000000000001', 'goal_setting', 'Goal Setting', '2025-05-01', '2025-06-30', false),
  ('c0000000-0000-0000-0000-000000000002', 'q1',           'Q1 Check-in',  '2025-07-01', '2025-09-30', true),
  ('c0000000-0000-0000-0000-000000000003', 'q2',           'Q2 Check-in',  '2025-10-01', '2025-12-31', false),
  ('c0000000-0000-0000-0000-000000000004', 'q3',           'Q3 Check-in',  '2026-01-01', '2026-03-31', false),
  ('c0000000-0000-0000-0000-000000000005', 'q4',           'Q4 / Annual',  '2026-03-01', '2026-04-30', false);
...
INSERT INTO goals (id, sheet_id, thrust_area, title, uom_type, target_value, target_date, weightage, is_shared, is_readonly) VALUES
  ...
  ('g0000000-0000-0000-0000-000000000002', 's0000000-0000-0000-0000-000000000001',
   'Operations', 'Customer TAT Reduction', 'numeric_max', 48, NULL, 25, false, false),
  ('g0000000-0000-0000-0000-000000000003', 's0000000-0000-0000-0000-000000000001',
   'Customer', 'CRM System Rollout', 'timeline', NULL, '2025-09-30', 30, false, false),
  ('g0000000-0000-0000-0000-000000000004', 's0000000-0000-0000-0000-000000000001',
   'Safety', 'Safety Incidents (Dept KPI)', 'zero', 0, NULL, 15, true, true);

-- Employee 2 (Priya) — Submitted sheet, 4 goals
INSERT INTO goals (id, sheet_id, thrust_area, title, uom_type, target_value, target_date, weightage, is_shared, is_readonly) VALUES
  ('g0000000-0000-0000-0000-000000000005', 's0000000-0000-0000-0000-000000000002',
   'Revenue', 'Sales Pipeline Growth', 'numeric_min', 5000000, NULL, 35, false, false),
  ('g0000000-0000-0000-0000-000000000006', 's0000000-0000-0000-0000-000000000002',
   'Customer', 'NPS Score Improvement', 'numeric_min', 75, NULL, 30, false, false),
  ('g0000000-0000-0000-0000-000000000007', 's0000000-0000-0000-0000-000000000002',
   'People', 'Professional Dev Hours', 'numeric_min', 40, NULL, 20, false, false),
  ('g0000000-0000-0000-0000-000000000008', 's0000000-0000-0000-0000-000000000002',
   'Safety', 'Safety Incidents (Dept KPI)', 'zero', 0, NULL, 15, true, true);

-- Employee 3 (Rahul) — Returned sheet, 2 goals
INSERT INTO goals (id, sheet_id, thrust_area, title, uom_type, target_value, target_date, weightage, is_shared, is_readonly) VALUES
  ('g0000000-0000-0000-0000-000000000009', 's0000000-0000-0000-0000-000000000003',
   'Revenue', 'Regional Revenue Target', 'numeric_min', 2000000, NULL, 50, false, false),
  ('g0000000-0000-0000-0000-000000000010', 's0000000-0000-0000-0000-000000000003',
...
INSERT INTO achievements (id, goal_id, quarter, actual_value, actual_date, status, progress_score) VALUES
  ...
  ('a0000000-0000-0000-0000-000000000002', 'g0000000-0000-0000-0000-000000000002',
   'q1', 36, NULL, 'on_track', 100),
  ('a0000000-0000-0000-0000-000000000003', 'g0000000-0000-0000-0000-000000000003',
   'q1', NULL, '2025-09-25', 'on_track', 100),
  ('a0000000-0000-0000-0000-000000000004', 'g0000000-0000-0000-0000-000000000004',
   'q1', 0, NULL, 'completed', 100),
  ('a0000000-0000-0000-0000-000000000005', 'g0000000-0000-0000-0000-000000000008',
   'q1', 0, NULL, 'completed', 100);

-- ─── CHECK-IN COMMENTS ───────────────────────────────────────────────────────
INSERT INTO checkin_comments (id, sheet_id, quarter, manager_id, comment_text, created_at) VALUES
  ('cc000000-0000-0000-0000-000000000001',
   's0000000-0000-0000-0000-000000000001', 'q1',
...
INSERT INTO escalation_rules (id, rule_type, label, threshold_days, is_active) VALUES
  ('er000000-0000-0000-0000-000000000001', 'submission_overdue', 'Goal Submission Overdue', 7, true),
  ('er000000-0000-0000-0000-000000000002', 'checkin_overdue',    'Check-in Not Completed', 14, true);

-- ─── ESCALATION EVENTS ───────────────────────────────────────────────────────
INSERT INTO escalation_events (id, rule_id, target_user, days_overdue, triggered_at, resolved) VALUES
  ('ee000000-0000-0000-0000-000000000001',
   'er000000-0000-0000-0000-000000000001',
   '00000000-0000-0000-0000-000000000003',
