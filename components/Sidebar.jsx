...
const NAV = {
  employee:[
    { icon:LayoutDashboard, label:"Dashboard",    p:"e-dash",    href:"/employee/dashboard"   },
    { icon:Target,           label:"My Goals",     p:"e-goals",   href:"/employee/goals"  },
    { icon:CheckCircle,      label:"Check-In",     p:"e-checkin", href:"/employee/checkin"},
  ],
  manager:[
    { icon:LayoutDashboard, label:"Dashboard",    p:"m-dash",    href:"/manager/dashboard"    },
    { icon:Users,            label:"Team",         p:"m-team",    href:"/manager/dashboard"   },
    { icon:FileText,         label:"Reports",      p:"m-reports", href:"/manager/reports"},
  ],
  admin:[
    { icon:LayoutDashboard, label:"Dashboard",    p:"a-dash",    href:"/admin/dashboard"     },
    { icon:CalendarDays,     label:"Cycles",       p:"a-cycles",  href:"/admin/cycles"  },
    { icon:Users,            label:"Users",        p:"a-users",   href:"/admin/users"   },
    { icon:Unlock,           label:"Unlock Goals", p:"a-unlock",  href:"/admin/unlock"  },
    { icon:Shield,           label:"Audit Trail",  p:"a-audit",   href:"/admin/audit"   },
    { icon:TrendingUp,       label:"Analytics",    p:"a-analytics",href:"/admin/analytics"},
    { icon:Zap,              label:"Escalations",  p:"a-esc",     href:"/admin/escalations"     },
  ],
}
